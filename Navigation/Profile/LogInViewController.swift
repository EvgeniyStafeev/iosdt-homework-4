...
class LogInViewController: UIViewController {
    ...
    private lazy var userLoginTextField: UITextField = {
        ...
        userLoginTextField.leftViewMode = .always
        userLoginTextField.leftView = UIView(frame: CGRect(x: 0, y: 0, width: 5, height: 0))
    ...
    private lazy var userPasswordTextField: UITextField = {
        ...
        userPasswordTextField.leftView = UIView(frame: CGRect(x: 0, y: 0, width: 5, height: 0))
