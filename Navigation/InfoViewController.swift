...
class InfoViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @objc func tap() {
        let alertVC = UIAlertController(title: "Alert", message: "Вы прочитали текст?", preferredStyle: .actionSheet)
        let actionOne = UIAlertAction(title: "Да", style: .default, handler: {(UIAlertAction) in print("Да")})
        let actionTwo = UIAlertAction(title: "Нет", style: .default, handler: {(UIAlertAction) in print("Нет")})
